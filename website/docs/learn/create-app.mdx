...
The scirpt would automatically create codes of a hello-world bot. Now
...
Bot should now answer the string we `reply("...")` with:

<img width={400} src={require("./assets/hello-todo-bot.png").default} />

---

Our first bot is running! Next, we'll teach it how to recieve messsges and
make the answer.
