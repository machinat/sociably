---
title: Native UI and Callback
---

> Plain text and textual tags like `<b>...</b>` work across platforms,
...
We can use the data later to handle the callback event.
...
Our bot can interact with users using buttons and callback.
