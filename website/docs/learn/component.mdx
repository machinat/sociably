...
Now we know how to use both general and native UI. While the UI getting more
...
UI to be sent. The component then can be used just like a native component:
...
customized **component** now. Next, we'll show user real data with these UI.
