...
<img width={500} src={require("./webview-1.png").default} />
...
<img width={500} src={require("./webview-2.png").default} />
...
<video width={450} autoplay="autoplay" loop inline>
  <source src={require("./assets/webview-3.webm").default} type="video/webm" />
</video>
