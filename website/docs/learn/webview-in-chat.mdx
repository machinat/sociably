...
- Check the complete [Todo Example](https://github.com/machinat/sociably-todo-example/).
  You can find some omitted features there, like [paging](https://github.com/machinat/sociably-todo-example/blob/main/src/components/ShowTodos.tsx)
  and [editing todo](https://github.com/machinat/sociably-todo-example/blob/main/webview/pages/index.tsx#L46-L65).
- Check more examples:
  - [Note Example](https://github.com/machinat/sociably-note-example) - take notes in the webview.
  - [Pomodoro Eample](https://github.com/machinat/sociably-pomodoro-example) - pomodoro timer in chat.
  - [4digits Example](https://github.com/machinat/sociably-4digits-example) - play guessing 4 digits game in chat.
