...
- [Facebook](https://facebook.com)`}${when(platforms.includes('instagram'))`
- [Instagram](https://instagram.com)`}${when(platforms.includes('whatsapp'))`
- [WhatsApp](https://whatsapp.com)`}${when(platforms.includes('telegram'))`
