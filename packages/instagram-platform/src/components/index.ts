...
import { MessengerIntermediateSegment } from '@sociably/meta-messenger-platform-base';
import * as Messenger from '@sociably/meta-messenger-platform-base/components';
