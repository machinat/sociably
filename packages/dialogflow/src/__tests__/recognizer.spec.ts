...
describe('.detectText()', () => {
  ...
  test('detect under machinat environment', async () => {
    ...
    expect(client.detectIntent.mock.calls[0].args[0]).toMatchInlineSnapshot(`
      Object {
        ...
        "session": "projects/test/agent/environments/machinat-entry/users/-/sessions/foo.chat",
      }
    `);
  });
    ...
    expect(client.detectIntent.mock.calls[0].args[0]).toMatchInlineSnapshot(`
      Object {
        ...
        "queryParams": Object {
          "contexts": Array [
            Object {
              "name": "projects/test/agent/environments/machinat-entry/users/-/sessions/foo.chat/contexts/bar",
            },
            Object {
              "name": "projects/test/agent/environments/machinat-entry/users/-/sessions/foo.chat/contexts/baz",
            },
          ],
          "geoLocation": Object {
            "latitude": 25.0456,
...
describe('.train()', () => {
  ...
  const environment = {
    name: 'projects/test/agent/environments/machinat-entry',
    description: '...',
      ...
      [
        {
          ...
          description: '@machinat/dialogflow:V0:out-dated-version',
        },
      ],
    ],
    createVersion: async () => [
  ...
  test('start from empty project', async () => {
    ...
    environmentsClient.getEnvironment.mock.fake(async () => {
      const err = new Error(
        "5 NOT_FOUND: com.google.apps.framework.request.NotFoundException: Environment 'machinat-entry' not found for agent with internal ID '51adb532-5bfd-429e-94af-3fbcf2029d33'"
      );
      (err as any).code = 5;
      throw err;
    });
    ...
    expect(agentsClient.setAgent.mock.calls[0].args[0]).toMatchInlineSnapshot(`
      Object {
        "agent": Object {
          "defaultLanguageCode": "ja",
          "description": "This agent is generated by @machinat/dialogflow package",
          "displayName": "machinat-agent",
          "parent": "projects/test",
    ...
    expect(versionsClient.createVersion.mock.calls[0].args[0])
      ...
      Object {
        "parent": "projects/test/agent",
        "version": Object {
          "description": "@machinat/dialogflow:V0:c08fccf84d0eb503d0bc1356741d45f64c18a072",
        },
      }
    `);
    ...
    expect(environmentsClient.createEnvironment.mock.calls[0].args[0])
      ...
      Object {
        "environment": Object {
          ...
          "description": "This evnironment is generated by @machinat/dialogflow package",
        },
        "environmentId": "machinat-entry",
        "parent": "projects/test/agent",
      }
    `);
    expect(
  ...
  test('create a new version', async () => {
    ...
    expect((environmentsClient.auth.request as any).mock.calls[0].args[0])
      ...
      Object {
        ...
        "url": "https://dialogflow.googleapis.com/v2/projects/test/agent/environments/machinat-entry",
      }
    `);
  });
      ...
      [
        {
          name: versionName,
          description:
            '@machinat/dialogflow:V0:c08fccf84d0eb503d0bc1356741d45f64c18a072',
        },
      ],
    ]);
    ...
    expect(versionsClient.createVersion.mock.calls[0].args[0]).toEqual({
      ...
      version: {
        description: expect.stringMatching(
          /^@machinat\/dialogflow snapshot at \d+-\d+-\d+T\d+:\d+:\d+.\d+Z$/
        ),
      },
    });
