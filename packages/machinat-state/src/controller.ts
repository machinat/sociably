...
class StateAccessor {
  _repository: RepositoryI;
  name: string;

  constructor(repository: RepositoryI, name: string) {
...
export const ControllerP = provider<StateController>({
  lifetime: 'scoped',
  deps: [RepositoryI],
})(StateController);

export type ControllerP = StateController;
